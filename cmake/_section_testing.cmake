...
macro(add_gtest test_name)
    ...
    target_include_directories(${test_name} PRIVATE src  ${jsoncpp_INCLUDE_DIRS})
    target_link_libraries(${test_name} ${PROJECT_NAME} ${GTEST_BOTH_LIBRARIES} pthread jsoncpp)
